...
class driving_mode_dataloader(tf.keras.utils.Sequence):
    def __init__(self, dataset_path, max_km, driver, data, pre_sec, batch_size=32, valid_ratio=0.2, image_size='large', no_response='ignore', bio_columns = ['EDA', 'BVP', 'HR']):
...
def main():
    ...
    dataloader = driving_mode_dataloader(
        ...
        data='front_image',  # ['can', 'front_image', 'side_image', 'bio', 'audio']
